...
//             <input
//               className={cn(
//                 "w-full h-[46px] border-[1px] border-solid border-dark-103 tracking-[0px] text-[12px] text-blue-200 p-[16px] cursor-pointer placeholder:text-dark-100 placeholder:font-normal rounded outline-none",
//                 "font-inter",
...
//           >
//             {showDropdown && (
//               <FlexColStart className="w-full mt-1 absolute z-20 bg-white-100 shadow-lg rounded-[8px]">
...
//                     ))
//                   ) : (
//                     <li className="p-[16px] cursor-pointer">No options available</li>
//                   )}
//                 </ul>
//               </FlexColStart>
//             )}
