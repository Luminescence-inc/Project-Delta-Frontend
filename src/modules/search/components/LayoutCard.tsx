    ...
    <CardWrapper className="w-full max-h-[110px] pb-[10px] gap-1">
      <FlexRowStartCenter className="w-full px-[0px] gap-1">
        ...
        <FlexColStart className="w-full px-[5px] gap-0 mt-2">
          ...
          <FlexRowStartCenter className="gap-[5px] h-[16px] py-[15px]">
            <MapPin size={15} className="stroke-gray-100/70" />
            <span className="text-[13px] font-light font-pp text-blue-200 mt-[3px]">
              {location}
            </span>
          </FlexRowStartCenter>
          ...
          <FlexRowStartCenter className="w-full gap-1">
            ...
            <FlexRowEnd className="w-auto">
              <a
                href={`tel:${phone}`}
                className="flex flex-row font-pp font-light items-center justify-center text-blue-200 bg-blue-202 w-[35px] h-[25px] px-[5px] rounded-full gap-[5px] text-[12px] businesss-call-line"
              >
                <Phone size={15} className="stroke-blue-200/80" />
              </a>
            </FlexRowEnd>
